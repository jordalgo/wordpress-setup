...
<?php if ( have_comments() ) : ?>
	...
	<ul class="commentlist">
		<?php wp_list_comments('type=comment&callback=dalgo_comments'); ?>
	</ul>
...
<section id="respond" class="respond-form">
	...
	<ul id="comment-form-elements" class="clearfix">
		...
		<li>
		  <label for="author">Name <?php if ($req) echo "<span class=\"alert\">(required)</span>"; ?></label>
		...
		<li>
		  <label for="email">Mail <?php if ($req) echo "<span class=\"alert\">(required)</span>"; ?></label>
